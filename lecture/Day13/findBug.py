...
# 1. interactive 디버깅 실습 - 홀수와 짝수 / 버그 찾기

# number = int(input()) # Which number do you want to check?

# if number % 2 = 0: # ------------ 여기서 오류발생 !
#     print("This is an even number.")
# else:
#     print("This is an odd number.")

# 오류 발생 이유 -> 대입(=) 이 아니라 동등비교 연산자(==)를 사용해야한다.

# -----------------------------------------------------------------------

# 2. interactive 디버깅 실습 - 윤년 문제 / 버그 찾기
...
# 오류발생 이유 -> input 으로 입력을 받으면 String타입으로 입력을 받기때문에 int로 형변환을 해서 받아줘야한다.

# -----------------------------------------------------------------------

# 3. interactive 디버깅 실습 - 피즈-버즈 디버깅 / 버그 찾기

# target = int(input())

# for number in range(1, target + 1):
#     if number % 3 == 0 or number % 5 == 0: # -------------첫번째 문제 !
#         print("FizzBuzz")
#     if number % 3 == 0: # ----------- 두번째 문제 !
#         print("Fizz")
#     if number % 5 == 0: # ----------- 두번째 문제 !
#         print("Buzz")
#     else:
#         print([number]) # ----------- 문제까진 아니지만 [](대괄호) 를 굳이 쓸 필요가 없다 !

# 오류발생 이유 -> 1. or 이 아닌 and 로 수정해야한다.
# 2. 두번째 세번째 if 를 elif 로 수정해야한다.
